 ...
 * @author DELL'
 */
@WebServlet(name = "EditQuantityWLController", urlPatterns = {"/EditQuantityWLController"})
public class EditQuantityWLController extends HttpServlet {
